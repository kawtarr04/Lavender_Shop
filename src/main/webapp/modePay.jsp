...
<div class="banner">
  ...
  <div class="centered-rectangle">
      ...
      <div class="text-center">
        <a href="payement.jsp"><button type="submit" class="btn">Payement Par Carte Bancaire</button></a>
        <a href="livraison.jsp"><button type="submit" class="btn">Payement à la Livraison</button></a>
      </div>
    </form>
  </div>
</div>
